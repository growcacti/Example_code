...
HOLE_INFO = {
    1: {
        "ramps": [((855, 279, 373, 27), (0, -1)), ((855, 347, 373, 48), (0, 1))],
        "hills": [],
        "ball pos": (150, 200),
        "cup pos": (1047, 480),
        "par": 3,
    ...
    3: {
        "ramps": [((343, 86, 322, 22), (-1, 0)), ((343, 86, 17, 211), (0, 1))],
        "hills": [],
        "ball pos": (714, 641),
        "cup pos": (351, 330),
        "par": 3,
    ...
    7: {
        "ramps": [((763, 253, 24, 32), (-1, 0)), ((496, 429, 24, 32), (-1, 0))],
        "hills": [],
        "ball pos": (567, 164),
        "cup pos": (705, 554),
        "par": 3,
    ...
    9: {
        "ramps": [((621, 121, 167, 292), (1, 0)), ((875, 311, 76, 352), (-1, 0))],
...
class CourseHole(pg.sprite.Sprite):
    ...
    def make_hills(self, hill_info):
        self.hills = [
            Hill(center, flat_radius, radius)
