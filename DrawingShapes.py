...
drawTriangle(
    220, 150, 250, 150, 235, 180, [255, 100, 50]
)  # or use an RGB colour definition

drawPolygon(
    [(110, 250), (290, 250), (280, 220), (120, 220)], "sienna"
)  # note the pairs of coordinates within the point list.
