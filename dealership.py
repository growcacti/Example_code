import random
from . import ship_components as sc
from . import products
from . import cargo_prices


SIZE_TO_QTY = {"tiny": 2, "small": 3, "medium": 5, "large": 8, "giant": 12}
...
class Dealership(object):
    ...
    def get_new_parts(self):
        ...
        for _ in range(SIZE_TO_QTY[self.size]):
            part_type, category = random.choice(list(CATEGORIES.items()))
            product_name = random.choice(list(category.keys()))
