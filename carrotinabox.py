...
p1Name = eval(input("Human player 1, enter your name: "))
p2Name = eval(input("Human player 2, enter your name: "))
...
eval(input("When " + p2Name + " has closed their eyes, press Enter..."))
print()
...
print()
eval(input("Then press Enter to continue..."))
...
eval(input("Press Enter to reveal the winner..."))
print()
