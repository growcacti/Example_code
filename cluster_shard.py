...
class ClusterShard(BaseProjectile):
    def __init__(self, initial_heading_vector, start_position, owner_id, *groups):
        ...
        self.bullet_position = [start_position[0], start_position[1]]
        ...
        self.bullet_life_time = 1.0
        self.should_die = False
        self.bounces = 0

        self.collisionDelta = 1.0

    def draw_last_collision(self, screen):
        pass

    def update(self, time_delta, all_sprites, maze_walls, players):
        # print("Updating shard: " + str(self.headingVector[0]) + ", " + str(self.headingVector[1]))
        collided = False
        ...
        if collided:
            ...
            # and then grab the tangent angle of that surface. We then pick our final normal
            # out of all our collided surfaces by comparing the dot product
