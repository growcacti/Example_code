...
def ask_game_parameters():
    ...
    for key in keys:
        ...
        # except ValueError:
        #    new_value = value
        new_value = turtle.numinput(
            title="change or accept parameter",
...
def calculate_world():
    ...
    myscreen.setworldcoordinates(
        Data.__lower_left_x,
        Data.__lower_left_y,
        Data.__upper_right_x,
        Data.__upper_right_y,
    )
    return myscreen
...
def make_grid():
    ...
    for y in range(
        Data.__lower_left_y,
        Data.__upper_right_y,
        (Data.__upper_right_y - Data.__lower_left_y) // 20,
    ):
    ...
    for x in range(
        Data.__lower_left_x,
        Data.__upper_right_x,
        (Data.__upper_right_x - Data.__lower_left_x) // 20,
    ):
...
def game():
    ...
    while True:
        ...
        menupen.penup()
        menupen.goto(
            Data.__lower_left_x + (Data.__upper_right_x - Data.__lower_left_x) // 2,
            Data.__upper_right_y - 10,
        )
        menupen.right(90)
        ...
        menupen.forward(20)
        menupen.write(
            "change angle and speed of your cannon to hit the target",
            align="center",
            font=("Arial", 15, "bold"),
        )
        menupen.forward(10)
        ...
        command = turtle.textinput(
            title="Cannon Game Menu",
